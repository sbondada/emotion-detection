...
def detect(image):
    ...
    # detect objects
    cascade = cv.LoadHaarClassifierCascade('/home/kaushal/Documents/Vedio2Text/jake/external/OpenCV-2.4.3/data/lbpcascades/lbpcascade_frontalface.xml', cv.Size(1,1))
